  ...
  <div className="bg-background flex min-h-screen items-center justify-center p-4">
    <div className="w-full max-w-md">
      ...
      <RegisterForm
        ...
        onSwitchToLogin={() => alert('Switch to login clicked! (Login form coming in task 3.3)')}
      />

      <div className="mt-6 text-center">
        <a className="text-muted-foreground hover:text-foreground text-sm transition-colors" href="/">
          ← Back to main app
        </a>
      </div>
    </div>
